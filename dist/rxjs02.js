...
var source1 = Rx.Observable.of('lurance', 'he');

source1.subscribe(function (value) {
...
var ary = [1, 2, 3, 4];
var source2 = Rx.Observable.from(ary);
source2.subscribe(function (value) {
    return console.log(value);
});
...
var source3 = Rx.Observable.fromPromise(new Promise(function (resolve, reject) {
    setTimeout(function () {
        resolve('Hello RxJS!');
    }, 3000);
}));
...
var source4 = Rx.Observable.throw('Oop!');

source4.subscribe(function (value) {}, function (err) {
    return console.error(err);
}, function () {
    return console.log('Throw Complete');
} // 不会执行
);
// Oops!
...
var source5 = Rx.Observable.interval(500);

var subscription5 = source5.subscribe(function (value) {
    return console.log(value);
});
...
var source6 = Rx.Observable.timer(1000, 2000);
source6.subscribe(function (value) {
    return console.log('source6: ' + value);
});

var source7 = Rx.Observable.timer(1000);
source7.subscribe(function (value) {
    return console.log('source7: ' + value);
}, function (err) {}, function () {
    return console.log('source7 Complete');
});
...
//# sourceMappingURL=rxjs02.js.map